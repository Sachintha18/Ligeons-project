...
<body>
    ...
    <div id="wrapper m">
        <div class="page-wrapper">
            <!-- header of the page -->
            <header class="fixed-top main-header  header-logo-center" id="waituk-main-header">
                <div id="nav-section">
                    <div class="bottom-header container mega-menus" id="mega-menus">
                        <nav class="navbar navbar-toggleable-md no-border-radius no-margin mega-menu-multiple flex-column" id="navbar-inner-container">
                            ...
                            <a class="navbar-brand  justify-content-between mr-auto m-sm-auto" href="index.php"> <img class="logosize1" src="img/logo-dark.png" > </a>
                            <div class="collapse navbar-collapse justify-content-center" id="mega-menu">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown" data-animation="fadeIn">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="index.php" data-title="Home">Services </a>
                                        <ul class="dropdown-menu no-border-radius">
                                            <li><a href="clients.php"> Our Clients </a></li>
                                            <li><a href="prices_package.php"> Prices & Packages </a></li>
