        ...
        <div class="page-wrapper">
            ...
            <main>
                ...
                <section class="visual">
                    <div class="visual-inner visual-banner-v4 dark-overlay parallax" data-stellar-background-ratio="0.55">
                        <div class="centered">
                            <div class="container">
                    ...
                    <section class=" text-center">
                        <div class="container">
                            <div class="demo-wrapper">
                                <h3 class="text-center element-heading">Youtube Video</h3>
                                <div class="media-block mb-5">
                                    <!-- 16:9 aspect ratio -->
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe src="https://www.youtube.com/embed/UgZmsphn510" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </div>
